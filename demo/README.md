...
| | |
|---|---|
| **Deck** | `demo/public/deck.html` — 12 slides plus an unshown appendix, and four more parked in HTML comments. Self-contained: no network, no build, opens from a file path |
